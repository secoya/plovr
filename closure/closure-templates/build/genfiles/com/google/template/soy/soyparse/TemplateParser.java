...
public class TemplateParser implements TemplateParserConstants {
  ...
  Token basicRawTextChar;
    ...
    int lineNum;
    basicRawTextChar = jj_consume_token(BASIC_RAW_TEXT_CHAR);
 ...
 */
  ...
  SourceItemInfo<String> basicRawText;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case BASIC_RAW_TEXT_CHAR:
      basicRawText = BasicRawText();
      if (basicRawText.parsedContent.trim().length() != 0) {

        {if (true) throw new ParseException(errorMessage + " Found on line " +
  ...
  final private void ContiguousRawTextLookaheadHelper() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case BASIC_RAW_TEXT_CHAR:
      jj_consume_token(BASIC_RAW_TEXT_CHAR);
      break;
    default:
      jj_la1[13] = jj_gen;
      ...
      while (true) {
        ...
        if (jj_2_19(2147483647)) {
          ...
          if (! (stmt instanceof MsgPlaceholderInitialContentNode)) {
            ...
            {if (true) throw new SoySyntaxException(
  ...
  Token tagOpen;
  List<StandaloneNode> templateBlock;
    tagOpen = jj_consume_token(MSG_HTML_TAG_OPEN);
    templateBlock = TemplateBlock();
    ...
    {if (true) return setLocation(new MsgHtmlTagNode(nodeIdGen.genId(), templateBlock), lineNum);}
    throw new Error("Missing return statement in function");
  }
  ...
  SourceItemInfo<List<String>> printTagParts;
    ...
    if (cmdTextParts.isEmpty()) {
      {if (true) throw new SoySyntaxException("Found 'print' command with empty command text.");}
    }
  ...
  private boolean jj_3_1() {
    if (jj_scan_token(BASIC_RAW_TEXT_CHAR)) return true;
    return false;
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x60,0x0,0x0,0xff0ffe00,0x0,0x0,0x0,0xff0ffe00,0x0,0xfe00,0x60,0x0,0x60,0x0,0x60,0x16040000,0x60,0x60,0xff0ffe00,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0xa0140000,0x40280000,0xffff,0x1b000000,0x3000000,0x1b000000,0xffff,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xa5,0x0,0x0,0x1800ffff,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x800,0x0,0x0,0x800,0x0,0x800,0x0,0x0,0x0,0x20,0x0,};
   }
